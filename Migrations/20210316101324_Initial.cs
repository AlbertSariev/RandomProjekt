    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanesAirports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanesAirports_Airports_AirportId",
                        column: x => x.AirportId,
                        principalTable: "Airports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlanesAirports_Planes_PlaneId",
                        column: x => x.PlaneId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pnone = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Planes_CityId",
                table: "Planes",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanesAirports_AirportId",
                table: "PlanesAirports",
                column: "AirportId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanesAirports_PlaneId",
                table: "PlanesAirports",
                column: "PlaneId");
